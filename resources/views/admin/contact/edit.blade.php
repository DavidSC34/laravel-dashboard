      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin.contact.update',$contacto->id)}}" method="POST" enctype="multipart/form-data"> 
                    @csrf
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="nombre" class="form-control" value="{{old('nombre',$contacto->nombre)}}">
                      </div>
                    </div>
                    {{-- Apellido --}}
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="apellido" class="form-control" value="{{old('apellido',$contacto->apellido)}}">
                      </div>
                    </div>
                     {{-- Email --}}
                     <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <select name="categoria" class="form-control selectric" >
                            <option>Select</option>
                              ...
                              <option {{$categoria->nombre === $contacto->categoria ? 'selected':''}} value="{{$categoria->nombre}}" >{{$categoria->nombre}}</option>
                              @endforeach
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sexo" id="masculino" value="MASCULINO" {{$contacto->sexo ==='MASCULINO' ? 'checked':''}}>
                                <label class="form-check-label" for="masculino">
                                    Masculino
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sexo" id="femenino" value="FEMENINO" {{$contacto->sexo ==='FEMENINO' ? 'checked':''}}>
                        ...
                        <div class="col-sm-12 col-md-7">
                          <select name="pais" class="form-control selectric" id="pais">
                            <option>Select</option>
                              ...
                              <option value="{{$pais->Name}}" {{$pais->Name === $contacto->pais ? 'selected':''}}>{{$pais->Name}}</option>
                              @endforeach
                     ...
                     <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <select name="estado" class="form-control selectric" id="estado">
                                ...
                                <option value="gjg" >{{$province->Name}}</option>
                                @endforeach
